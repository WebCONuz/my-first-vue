const app = Vue.createApp({
  ...
  // Ham ma'lumotlar, ham metodlar saqlanadi
  // Metodlar va ularning qaytargan qiymatini saqlaydi. Bu yerda filterOnline => [online users]
  computed: {
    filterOnline() {
  ...
  // Ma'lumotlarni o'zgartiruvchi metodlar saqlanadi
  methods: {
    setToggle() {
